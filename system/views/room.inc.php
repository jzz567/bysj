<section>
    ...
    <ul id="online">在线人数:<img style="width: 15px"
                              src="https://jzz15.oss-cn-shenzhen.aliyuncs.com/images%2Floading.gif"/>
    </ul>
    <div style="width: 600px;height: 350px;text-align: center;">
        <select id="online_list" disabled="disabled"
                style="background-color: white;margin-left: 10px;width: 80px;height:303px;display: inline;float: left;text-align: center;list-style: none;border-top-left-radius:6px;border-bottom-left-radius:6px;box-shadow: 0 0 10px rgba(31, 27, 12, .3);text-shadow: 0 0 10px rgba(31, 27, 12, .3);border:none;"
